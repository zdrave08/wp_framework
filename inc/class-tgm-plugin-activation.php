...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		 ...
		 */
		const TGMPA_VERSION = '1.0.0';//Change by Zdravko Lukic, original version '2.5.2'
			...
			echo '<p style="float: right; padding: 0em 1.5em 0.5em 0;"><strong><small>',
				esc_html(
					sprintf(
						...
						__( 'Framework v%s', 'tgmpa' ),//Change by Zdravko Lukic, original version 'TGMPA'
						self::TGMPA_VERSION
					)
				),
				'</small></strong></p>';
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function get_row_actions( $item ) {
			...
			if ( ! $this->tgmpa->is_plugin_installed( $item['slug'] ) ) {
				...
				$actions['install'] = __( 'Install', 'tgmpa' );//change by Zdravko Lukic, original version is 'Install %s'
			} else {
